    ...
    contentBase [ id "Experience" ] <|
        contentHeader [] [ text "Experience" ]
            :: List.map (card expandedCards)
                ...
                , ( jetInternDetails, expDetails jetInternDetails.details )
                , ( microsoftDetails, expDetails microsoftDetails.details )
                , ( nasaDetails, expDetails nasaDetails.details )
                , ( templeDetails, expDetails templeDetails.details )
                ]